...
#
# Generated by Vivado on Mon May 15 22:53:31 +0800 2023
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="E:/vivado_projects/CS202_Project/CS202-Project/CS202-Project.cache/compile_simlib/activehdl"
  fi
